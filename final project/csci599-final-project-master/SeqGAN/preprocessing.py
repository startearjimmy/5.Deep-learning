            ...
            for event in part._elements:
                ...
                if event.isStream:
                    ...
                    for i in event._elements:
                        _part_tuples = self.streaming( i,event, _part_tuples)
...
if __name__ == "__main__":
    ...
    with open('./dataset/dataset_try', 'wb') as fp:
        pickle.dump(dataset, fp)

    # fraction to float & for python2
    with open('./dataset/dataset_try', 'rb') as fp:
        ...
        with open('./dataset/dataset_try2', 'wb') as fp:
