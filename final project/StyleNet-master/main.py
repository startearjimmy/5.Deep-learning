...
def setup_dir():
    ...
    x_path = os.path.join(files_path, 'inputs')#inputs
    y_path = os.path.join(files_path, 'velocities') #answer
    eval_path = os.path.join(files_path, 'eval') #validation set

    model_path = os.path.join(current_run, 'model') #model file
    logs_path = os.path.join(current_run, 'tmp') #log file
    png_path = os.path.join(current_run, 'png') #png visualize the network structure
    pred_path = os.path.join(current_run, 'predictions') #outputs
