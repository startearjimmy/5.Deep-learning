...
class BatchGenerator(object):
    ...
    def __init__(self, data_x, data_y, batch_size, input_size, output_size, mini=True, mini_len=200):
        ...
        print('len(self.data_x[0][0])',len(self.data_x[0][0]))
        print('len(self.data_y)',len(self.data_y))
        print('len(self.data_y[0])',len(self.data_y[0]))
        print('len(self.data_y[0][0])',len(self.data_y[0][0]))
        print('self.batch_size',self.batch_size)
        print('self.batch_count',self.batch_count)
        print('\n')
